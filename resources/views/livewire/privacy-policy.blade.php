...
<div>
    ...
    <div class="">{{ __('Postman Privacy Policy.') }}</div>
    ...
    <p class="mt-5">{{ __('Changes to This Privacy Policy') }}</p>
    ...
    <p class="mt-5">{{ __('What Personal Information We Collect') }}</p>
    ...
    <p class="mt-5">{{ __('Information We Collect Directly from You') }}</p>
    ...
    <p class="mt-5">{{ __('Information We Collect through Cookies') }}</p>
    ...
    <p class="mt-5">{{ __('How We Use Your Personal Information') }}</p>
    ...
    <p class="mt-5">{{ __('We use Cookies to power and improve our Site and our Services (including to remember your actions and
    ...
    <p class="mt-5">{{ __('Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser
        ...
        including certain features and general functionality, to work incorrectly or no longer be available.') }}</p>

    <p class="mt-5">{{ __('How We Disclose Personal Information') }}</p>
    ...
    <p class="mt-5">{{ __('The Services may enable you to post product reviews and other user-generated content. If you choose to submit user generated content to any public
        area of the Services, this content will be public and accessible by anyone.') }}</p>

    <p class="mt-5">{{ __('We do not control who will have access to the information that you choose to make available to others, and cannot ensure that parties who have access
        ...
        publicly available, or for the accuracy, use or misuse of any information that you disclose or receive from third parties') }}</p>

    <p class="mt-5">{{ __('Our Site doesn\'t provide links to websites or other online platforms operated by third parties') }}</p>

    <p class="mt-5">{{ __('Children\'s Data') }}</p>

    <p class="mt-5">{{ __('The Services are not intended to be used by children, and we do not knowingly collect any personal information about children. If you are the parent or
        guardian of a child who has provided us with their personal information, you may contact us using the ' ) }} <a href="{{ route('contact') }}" class="link ">{{ __('contact') }}</a> {{ __('page to request that it be
        deleted.') }}</p>

    <p class="mt-5">{{ __('As of the Effective Date of this Privacy Policy, we do not have actual knowledge that we "share" or "sell" (as those terms are defined in applicable law)
        personal information of individuals under 16 years of age.') }}</p>

    <p class="mt-5">{{ __('Security and Retention of Your Information') }}</p>

    <p class="mt-5">{{ __('Please be aware that no security measures are perfect or impenetrable, and we cannot guarantee "perfect security." In addition, any information you
