<div>
    <x-header title="{{ __('Create couriers` announcement') }}" subtitle="{{ __('If you would like to deliver something to someone, please fill out the form and post an ad.') }}" separator />
