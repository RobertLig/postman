    ...
    public function render(): View|Closure|string
    {
        return <<<'blade'
            <div class="grid sm:gap-x-5 sm:grid-cols-2 max-w-3xl" x-data="{
                ...
                <div class="relative">
                    <x-map-input label="{{ __('Posting place') }}" wire:model.live="postingPlace" @input.debounce.300ms="makeAutocompleteRequest($event, 'postingPlace')" placeholder="{{ __('Posting place') }}" clearable  /> 
                ...
                <div class="relative">
                    <x-map-input label="{{ __('Reception place') }}" wire:model.live="receptionPlace" @input.debounce.300ms="makeAutocompleteRequest($event, 'receptionPlace')" placeholder="{{ __('Reception place') }}" clearable />
