...
return [
    ...
    "senders-announcements-edit" => "ogłoszenia-nadawców/{sender}/edytuj",
    "senders-announcements-show" => "ogłoszenia-nadawców/{sender}",
    "couriers-announcements-create" => "ogłoszenia-kurierów/utwórz",
    "couriers-announcements" => "ogłoszenia-kurierów",
    "couriers-announcements-show" => "ogłoszenia-kurierów/{courier}",
    "couriers-announcements-edit" => "ogłoszenia-kurierów/{courier}/edytuj",
    "settings" => "ustawienia",
